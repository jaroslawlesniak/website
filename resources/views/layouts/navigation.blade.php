        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-left">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('ui.web-apps')</a>
                    ...
                    <a class="dropdown-item" href="/{{ App::getLocale() }}/craftcms">CraftCMS<span title="@lang('ui.completed-projects')">2</span></a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('ui.apps.title')</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('ui.graphics')</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
